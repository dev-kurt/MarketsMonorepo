...
include(":markets-features:search:domain:api")
include(":markets-features:search:data")
include(":markets-features:search:ui:api")
include(":markets-features:search:ui:impl")
include(":markets-features:search:di")